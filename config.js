...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "INFINITY-MD;;;=>7ZUliBxa#MSH4c1MADz59BQRoZELuGcroMyCHqkEDzx71auOED_w",
// add your Session Id 
...
BOT_NAME: process.env.BOT_NAME || "𝐒𝐄𝐍𝐊𝐔-MD",
// add bot namw here for menu
STICKER_NAME: process.env.STICKER_NAME || "</sᴛᴇᴇᴠʏ-ᴛᴇᴄʜ♾️/>",
...
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "*> 𝙥𝙤𝙬𝙚𝙧𝙚𝙙 𝙗𝙮 </sᴛᴇᴇᴠʏ-ᴛᴇᴄʜ♾️/>*",
// add bot owner name    
...
DEV: process.env.DEV || "50939130904",
